    ...
    companion object {
        fun fromModelDb(dbMembershipFunction: DBMembershipFunction): MembershipFunctionDTODb {
            return MembershipFunctionDTODb(
                ...
                functionType = DBMembershipFunctionType.fromString(dbMembershipFunction.functionType)
                    .toMembershipFunctionType(),
                ...
                hedgeType = DBLinguisticHedgeType.fromString(dbMembershipFunction.hedgeType).toLinguisticHedgeType()
            )
        }
    }
}
...
data class MembershipFunctionTemplateDTODb(
    ...
    fun toModelDb() = DBInsertableMembershipFunction(
        id = this.id,
        term = this.term,
        functionType = DBMembershipFunctionType.fromMembershipFunctionType(this.functionType).text,
        ...
        hedgeType = DBLinguisticHedgeType.fromLinguisticHedgeType(this.hedgeType).text
    )
